...
function connect() {
    ...
    return {
        ...
        Repositories: {
            tree: (projectName, sha) => __awaiter(this, void 0, void 0, function* () {
        ...
        RepositoryFiles: {
            show: (projectName, sha, fileName) => __awaiter(this, void 0, void 0, function* () {
        ...
        Tags: {
            all: (projectName) => __awaiter(this, void 0, void 0, function* () {
        ...
        Groups: {
            ...
            show: () => __awaiter(this, void 0, void 0, function* () {
